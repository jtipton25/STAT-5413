...
```{r stan-logistic-results, cache = TRUE}
...
```{r stan-logistic-ppc, cache = TRUE}
...
```{r stan-poisson, message = FALSE, eval = FALSE}
...
```{r stan-poisson-results, cache = TRUE, eval = FALSE}
## only plot the regression parameters
print(fit, probs = c(0.1, 0.9), pars = c("beta", "lp__"))
...
```{r stan-poisson-ppc, cache = TRUE, eval=FALSE}
p1 <- ppc_intervals(y, y_rep, x = X[, 2])
p2 <- ppc_dens_overlay(y, y_rep)  
p3 <- ppc_ecdf_overlay(y, y_rep)  
p1 / p2 / p3 
...
```{r nimble-poisson, cache = TRUE, eval=FALSE}
...
```{r stan-spatial-logistic, message = FALSE, eval=FALSE}
...
```{r stan-spatial-logistic-results, cache = TRUE, eval=FALSE}
## only plot the regression parameters
...
```{r stan-spatial-logistic-ppc, cache = TRUE, eval=FALSE}
p1 <- ppc_intervals(y, y_rep, x = X[, 2])
p2 <- ppc_dens_overlay(y, y_rep)
p3 <- ppc_ecdf_overlay(y, y_rep)
p1 / p2 / p3 
...
```{r stan-nonspatial-fit, cache = TRUE, message = FALSE, eval=FALSE}
...
```{r stan-nonspatial-fit-results, cache = TRUE, eval=FALSE}
## only plot the regression parameters
print(fit, probs = c(0.1, 0.9), pars = c("beta", "lp__"))
...
```{r stan-nonspatial-fit-ppc, cache = TRUE, eval=FALSE}
p1 <- ppc_intervals(y, y_rep, x = X[, 2])  
p2 <- ppc_dens_overlay(y, y_rep)  
p3 <- ppc_ecdf_overlay(y, y_rep)  
p1 / p2 / p3
...
```{r stan-poisson-spatial, message = FALSE, eval=FALSE}
...
```{r stan-poisson-spatial-results, cache = TRUE, eval=FALSE}
## only plot the regression parameters
print(fit, probs = c(0.1, 0.9), pars = c("beta", "tau2", "phi", "lp__"))
...
```{r stan-poisson-spatial-ppc, cache = TRUE, eval=FALSE}
p1 <- ppc_intervals(y, y_rep, x = X[, 2])
p2 <- ppc_dens_overlay(y, y_rep)
p3 <- ppc_ecdf_overlay(y, y_rep)  
p1 / p2 / p3  
...
```{r stan-poisson-nospatial, cache = TRUE, message = FALSE, eval=FALSE}
fit <- stan(
...
```{r stan-poisson-nospatial-results, cache = TRUE, eval=FALSE}
## only plot the regression parameters
print(fit, probs = c(0.1, 0.9), pars = c("beta", "lp__"))
...
```{r stan-poisson-nospatial-ppc, cache = TRUE, eval=FALSE}
p1 <- ppc_intervals(y, y_rep, x = X[, 2])
p2 <- ppc_dens_overlay(y, y_rep)
p3 <- ppc_ecdf_overlay(y, y_rep)   
p1 / p2 / p3   
...
```{r spatial-poisson-nimble, cache = TRUE, eval=FALSE}
...
```{r spatial-poisson-nimble-config, cache = TRUE, eval=FALSE}
